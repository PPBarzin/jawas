...
mod tests {
    ...
    fn context(
        ...
        PreparedExecutionContext {
            ...
            wallet_eligible,
            lending_market: "lending-market".to_string(),
            lending_market_authority: "lending-market-authority".to_string(),
            repay_reserve: "repay-reserve".to_string(),
            repay_supply: "repay-supply".to_string(),
            withdraw_reserve: "withdraw-reserve".to_string(),
            withdraw_mint: "withdraw-mint".to_string(),
            withdraw_collateral_mint: "withdraw-collateral-mint".to_string(),
            withdraw_collateral_supply: "withdraw-collateral-supply".to_string(),
            withdraw_liquidity_supply: "withdraw-liquidity-supply".to_string(),
            withdraw_liquidity_fee_receiver: "withdraw-liquidity-fee-receiver".to_string(),
